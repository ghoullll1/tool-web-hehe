    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/temporary-chat/sessions", "/api/v1/temporary-chat/sessions/join").permitAll()
                        .requestMatchers("/ws/v1/temporary-chat").permitAll()
